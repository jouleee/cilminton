                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="booking2.php">
                            <div class="form-group">
                                ...
                                <input type="date" name="date" class="form-control" id="date1" placeholder="Select Date" required />
                            </div>
                            <button type="submit" class="btn btn-primary mt-3">Find Available Times</button>
                        </form>
                    </div>
                </div>
            </div>
