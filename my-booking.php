...
if (!isset($_SESSION['id_customer'])) {
    echo "Session ID customer is not set.";
    exit();
}

$customerID = $_SESSION['id_customer'];
$bookings = getBooking($customerID);
?>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-center text-primary text-uppercase">My Booking</h6>
                    <h1 class="mb-5">Book A <span class="text-primary text-uppercase">Badminton Court</span></h1>
                </div>
                                ...
                                <table class="table table-bordered table-hover mb-0">
                                    <thead class="bg-primary text-white">
                                        <tr>
                                            ...
                                            <th class="text-center">Banyak Extra</th>
                                    ...
                                    <tbody>
                                        <?php foreach ($bookings as $booking) : ?>
                                            <tr>
                                                <td class="text-center"><?php echo $booking['Tanggal']; ?></td>
                                                <td class="text-center"><?php echo $booking['Jam']; ?></td>
                                                <td class="text-center"><?php echo $booking['Lapangan']; ?></td>
                                                <td class="text-center"><?php echo $booking['Extra']; ?></td>
                                                <td class="text-center"><?php echo $booking['Kuantitas_Extra']; ?></td>
